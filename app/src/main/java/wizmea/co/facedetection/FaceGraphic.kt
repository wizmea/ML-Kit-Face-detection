...
class FaceGraphic(overlay: GraphicOverlay) : GraphicOverlay.Graphic(overlay) {
    ...
    private fun showSmiley(canvas: Canvas, face: FirebaseVisionFace) {
        ...
        val bt = BitmapFactory.decodeResource(applicationContext.resources, R.drawable.happy_2)
        canvas.drawBitmap(bt, left, top, null)
    }


    private fun drawRect(canvas: Canvas, face: FirebaseVisionFace) {
